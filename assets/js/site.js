const TRANSLATIONS = {
  en: {
    ...
    "arithzo.store.kicker": "App Store",
    "arithzo.store.title": "Coming soon on the App Store",
    "arithzo.store.platform": "Platform: iOS",
  ...
  ja: {
    ...
    "arithzo.store.kicker": "App Store",
    "arithzo.store.title": "App Store で近日公開",
    "arithzo.store.platform": "対応プラットフォーム: iOS",
  ...
  "zh-Hans": {
    ...
    "arithzo.store.kicker": "App Store",
    "arithzo.store.title": "即将在 App Store 上架",
    "arithzo.store.platform": "平台：iOS",
  ...
  "zh-Hant": {
    ...
    "arithzo.store.kicker": "App Store",
    "arithzo.store.title": "即將在 App Store 上架",
    "arithzo.store.platform": "平台：iOS",
