const TRANSLATIONS = {
  en: {
    ...
    "app.subtitle": "Cache cleaner for Xcode",
    ...
    "arithzo.subtitle": "Mental math game for students",
    ...
    "arithzo.feature.3.title": "Streaks, combos, and achievements",
    "arithzo.feature.3.body": "Chain combo multipliers, keep your streak alive, and unlock achievements on the way to a new personal best.",
    ...
    "jlptbook.subtitle": "Vocabulary, Kanji & Grammar",
    ...
    "jlptbook.feature.3.title": "Fill-in mode for active recall",
    "jlptbook.feature.3.body": "Build each word's reading from tiles in tests and reviews, plus daily streaks and 30+ achievements to keep you coming back.",
    "jlptbook.store.appStore": "Open JLPT Book in App Store",
    "jlptbook.store.badgeAlt": "Download JLPT Book on the App Store",
    "jlptbook.screens.kicker": "Screenshots",
    "jlptbook.screens.title": "Study, review, and test — all in one place.",
    "jlptbook.screens.1.alt": "JLPT Book home screen",
    "jlptbook.screens.2.alt": "JLPT Book flashcard study screen",
    "jlptbook.screens.3.alt": "JLPT Book review screen",
    "jlptbook.screens.4.alt": "JLPT Book test screen",
    "jlptbook.screens.5.alt": "JLPT Book settings screen",
    ...
    "doubleslab.subtitle": "KO odds, spreads & matchups",
    "doubleslab.store.appStore": "Open DoublesLab in App Store",
    "doubleslab.store.badgeAlt": "Download DoublesLab on the App Store",
    ...
    "doubleslab.feature.2.body": "Account for weather, terrain, screens, Helping Hand, Friend Guard, Battery, Power Spot, status conditions, critical hits, and Tera.",
    "doubleslab.feature.3.title": "Showdown import, fully localized",
    "doubleslab.feature.3.body": "Import and export full teams in Showdown format, browse every species and move offline, and use the adaptive sidebar on iPad and Mac — in English, 日本語, 简体中文, and 繁體中文.",
    ...
    "doubleslab.screens.kicker": "Screenshots",
    "doubleslab.screens.title": "Calculate, optimize, and scout the meta.",
    "doubleslab.screens.1.alt": "DoublesLab damage calculator screen",
    "doubleslab.screens.2.alt": "DoublesLab SP optimizer screen",
    "doubleslab.screens.3.alt": "DoublesLab damage vs meta coverage screen",
    "doubleslab.screens.4.alt": "DoublesLab incoming threats screen",
    "doubleslab.screens.5.alt": "DoublesLab team analysis screen",
    "doubleslab.screens.6.alt": "DoublesLab Pokédex browser screen",
    ...
    "meta.offgridGallery.description": "A private photo and video library for iPhone, iPad, and Mac, with local storage, multiple vaults, and optional App Lock.",
    ...
    "offgridGallery.subtitle": "Private, on-device photo album",
    "offgridGallery.store.appStore": "Open Offgrid Gallery in App Store",
    "offgridGallery.store.badgeAlt": "Download Offgrid Gallery on the App Store",
    ...
    "offgridGallery.feature.1.body": "Import or capture photos and videos straight into a private library, with full-resolution originals stored on your device.",
    ...
    "offgridGallery.feature.3.body": "Optional Face ID or Touch ID App Lock keeps your library private, with multiple vaults so you can keep separate libraries side by side.",
    "offgridGallery.screens.kicker": "Screenshots",
    "offgridGallery.screens.title": "Your photos and videos, kept private.",
    "offgridGallery.screens.1.alt": "Offgrid Gallery photo grid",
    "offgridGallery.screens.2.alt": "Offgrid Gallery photo viewer",
    "offgridGallery.screens.3.alt": "Offgrid Gallery settings screen",
    "offgridGallery.screens.4.alt": "Offgrid Gallery album grid",
    ...
    "meta.offgridWebSaver.title": "Offgrid Web Saver | Save Photos from Instagram & X to Offgrid Gallery",
    "meta.offgridWebSaver.description": "Right-click any photo on Instagram or X and save the highest-resolution version straight into Offgrid Gallery, using free Safari and Chrome browser extensions for Mac.",
    "offgridWebSaver.iconAlt": "Offgrid Gallery app icon",
    "offgridWebSaver.title": "Offgrid Web Saver",
    "offgridWebSaver.subtitle": "Right-click a photo on Instagram or X, save the original straight into Offgrid Gallery.",
    "offgridWebSaver.availability": "For Mac · Safari & Chrome",
    "offgridWebSaver.download.appButton": "Download Offgrid Companion",
    "offgridWebSaver.download.chromeButton": "Download for Chrome",
    "offgridWebSaver.download.checking": "Checking for the latest version…",
    "offgridWebSaver.overview.kicker": "Overview",
    "offgridWebSaver.overview.title": "Instagram and X don't let you save photos. This does.",
    "offgridWebSaver.overview.body": "Right-click any photo and choose \"Save to Offgrid Gallery.\" The extension finds the highest-resolution version of that exact photo and hands it to Offgrid Gallery on your Mac — no screenshots, no quality loss, nothing uploaded anywhere else. It works on any site with images, not just Instagram and X.",
    "offgridWebSaver.setup.kicker": "Setup",
    "offgridWebSaver.setup.title": "Three steps to get saving.",
    "offgridWebSaver.setup.step1.title": "1. Open Offgrid Companion once",
    "offgridWebSaver.setup.step1.body": "Download and open the app once. It registers the Safari extension and, if you use Chrome, connects it automatically — then you can quit it or leave it running, whichever you prefer.",
    "offgridWebSaver.setup.step2.title": "2. Turn on Offgrid Saver in Safari",
    "offgridWebSaver.setup.step2.body": "In the app, click \"Open Safari Extension Settings,\" then turn on Offgrid Saver and allow it on the sites you use.",
    "offgridWebSaver.setup.step3.title": "3. Or load it unpacked in Chrome",
    "offgridWebSaver.setup.step3.body": "Download the Chrome version, unzip it, open chrome://extensions, turn on Developer Mode, then click \"Load unpacked\" and choose the unzipped folder.",
    "offgridWebSaver.setup.consentNote": "The first time you save a photo, macOS may show a one-time prompt asking to allow access to a shared app container — this is expected. Choose Allow so the photo can reach Offgrid Gallery.",
    "offgridWebSaver.faq.kicker": "FAQ",
    "offgridWebSaver.faq.title": "Good to know.",
    "offgridWebSaver.faq.q1": "Does this upload my photos anywhere?",
    "offgridWebSaver.faq.a1": "No. The photo goes straight from your browser to Offgrid Gallery on the same Mac — nothing is sent to any server, including ours.",
    "offgridWebSaver.faq.q2": "Which vault does it save to?",
    "offgridWebSaver.faq.a2": "Whichever vault is active in Offgrid Gallery. If that vault has iCloud Drive turned on, the save is routed there automatically, the same as any other import.",
    "offgridWebSaver.faq.q3": "Why do I need a separate app?",
    "offgridWebSaver.faq.a3": "Browser extensions can't write files to another app on their own. Offgrid Companion is a small, notarized helper that lets Safari and Chrome hand the photo off to Offgrid Gallery.",
    "offgridWebSaver.footer.tagline": "A right-click away from Offgrid Gallery.",
    "offgridWebSaver.footer.backLink": "Back to Offgrid Gallery",
  ...
  ja: {
    ...
    "arithzo.feature.3.title": "連続正解とコンボでスコアアップ",
    "arithzo.feature.3.body": "コンボ倍率と連続正解記録を積み重ね、実績を集めながら自己ベスト更新を目指せます。",
    ...
    "vocabularybook.feature.3.title": "AI穴埋めで文脈から学ぶ",
    "vocabularybook.feature.3.body": "Apple Intelligenceが生成する例文の穴埋めに挑戦。フラッシュカードやテストと合わせて、単語の意味と使い方を自然に身につけられます。",
    "vocabularybook.store.appStore": "App Storeで英単語ブックを開く",
    "vocabularybook.store.badgeAlt": "App Storeで英単語ブックをダウンロード",
    "vocabularybook.screens.kicker": "スクリーンショット",
    "vocabularybook.screens.title": "学習に迷わない、シンプルな画面設計。",
    "vocabularybook.screens.1.alt": "英単語ブックのホーム画面",
    "vocabularybook.screens.2.alt": "英単語ブックのレベル選択画面",
    "vocabularybook.screens.3.alt": "英単語ブックの復習画面",
    "vocabularybook.screens.4.alt": "英単語ブックのテスト設定画面",
    "vocabularybook.screens.5.alt": "英単語ブックのフラッシュカード画面",
    "vocabularybook.screens.6.alt": "英単語ブックのスペル入力画面",
    ...
    "doubleslab.subtitle": "ダブル対戦の耐久調整・乱数計算",
    "doubleslab.store.appStore": "App Storeでダブルスラボを開く",
    "doubleslab.store.badgeAlt": "App Storeでダブルスラボをダウンロード",
    ...
    "doubleslab.feature.2.body": "天候、フィールド、壁、てだすけ、フレンドガード、バッテリー、パワースポット、状態異常、急所、テラスタルに対応します。",
    "doubleslab.feature.3.title": "Showdownインポート・多言語対応",
    "doubleslab.feature.3.body": "Showdown形式でチームを一括インポート・エクスポートし、オフラインで全ポケモン・技を閲覧。iPad/Macの可変サイドバーにも対応し、英語・日本語・简体中文・繁體中文で利用できます。",
    ...
    "doubleslab.screens.kicker": "スクリーンショット",
    "doubleslab.screens.title": "計算、最適化、環境読みまでこの一本で。",
    "doubleslab.screens.1.alt": "ダブルスラボのダメージ計算画面",
    "doubleslab.screens.2.alt": "ダブルスラボのSP最適化画面",
    "doubleslab.screens.3.alt": "ダブルスラボの対環境ダメージ画面",
    "doubleslab.screens.4.alt": "ダブルスラボの脅威チェック画面",
    "doubleslab.screens.5.alt": "ダブルスラボのチーム分析画面",
    "doubleslab.screens.6.alt": "ダブルスラボの図鑑画面",
    ...
    "meta.offgridGallery.description": "端末内保存、複数の保管庫、任意のApp Lockに対応したiPhone・iPad・Mac向け写真・ビデオライブラリ。",
    ...
    "offgridGallery.title": "Offgrid Gallery",
    "offgridGallery.subtitle": "プライベートな端末内アルバム",
    "offgridGallery.store.appStore": "App StoreでOffgrid Galleryを開く",
    "offgridGallery.store.badgeAlt": "App StoreでOffgrid Galleryをダウンロード",
    ...
    "offgridGallery.feature.1.body": "写真やビデオを取り込む、またはその場で撮影してプライベートライブラリへ。フル解像度のオリジナルは端末内に保存されます。",
    ...
    "offgridGallery.feature.3.body": "任意のFace ID / Touch ID App Lockでライブラリを保護。複数の保管庫を使い分ければ、別々のライブラリを並行して管理できます。",
    "offgridGallery.screens.kicker": "スクリーンショット",
    "offgridGallery.screens.title": "写真もビデオも、プライベートに。",
    "offgridGallery.screens.1.alt": "Offgrid Galleryの写真グリッド",
    "offgridGallery.screens.2.alt": "Offgrid Galleryの写真ビューア",
    "offgridGallery.screens.3.alt": "Offgrid Galleryの設定画面",
    "offgridGallery.screens.4.alt": "Offgrid Galleryのアルバムグリッド",
    ...
    "meta.offgridWebSaver.title": "Offgrid Web Saver | InstagramやXの写真をOffgrid Galleryに保存",
    "meta.offgridWebSaver.description": "InstagramやXで写真を右クリックし、Mac用の無料のSafari・Chrome機能拡張で最高解像度の写真をOffgrid Galleryに直接保存します。",
    "offgridWebSaver.iconAlt": "Offgrid Gallery のアプリアイコン",
    "offgridWebSaver.title": "Offgrid Web Saver",
    "offgridWebSaver.subtitle": "InstagramやXの写真を右クリックして、オリジナルをOffgrid Galleryに直接保存します。",
    "offgridWebSaver.availability": "Mac対応 · Safari & Chrome",
    "offgridWebSaver.download.appButton": "Offgrid Companionをダウンロード",
    "offgridWebSaver.download.chromeButton": "Chrome版をダウンロード",
    "offgridWebSaver.download.checking": "最新バージョンを確認しています…",
    "offgridWebSaver.overview.kicker": "概要",
    "offgridWebSaver.overview.title": "InstagramとXでは写真を保存できません。これなら保存できます。",
    "offgridWebSaver.overview.body": "写真を右クリックして「Offgrid Galleryに保存」を選ぶだけ。機能拡張がその写真の最高解像度版を見つけ出し、Mac上のOffgrid Galleryに渡します。スクリーンショットも画質の劣化もなく、他のどこにもアップロードされません。InstagramやXに限らず、画像のあるどのサイトでも使えます。",
    "offgridWebSaver.setup.kicker": "セットアップ",
    "offgridWebSaver.setup.title": "3つのステップで保存できるようになります。",
    "offgridWebSaver.setup.step1.title": "1. Offgrid Companionを一度開く",
    "offgridWebSaver.setup.step1.body": "アプリをダウンロードして一度開きます。Safari機能拡張が登録され、Chromeを使用している場合は自動的に接続されます。その後はアプリを終了しても、起動したままにしてもかまいません。",
    "offgridWebSaver.setup.step2.title": "2. SafariでOffgrid Saverをオンにする",
    "offgridWebSaver.setup.step2.body": "アプリ内で「Safari機能拡張の設定を開く」をクリックし、Offgrid Saverをオンにして、使用するサイトでの実行を許可してください。",
    "offgridWebSaver.setup.step3.title": "3. またはChromeにパッケージ化されていない拡張機能として読み込む",
    "offgridWebSaver.setup.step3.body": "Chrome版をダウンロードして解凍し、chrome://extensionsを開いてデベロッパーモードをオンにし、「パッケージ化されていない拡張機能を読み込む」をクリックして解凍したフォルダを選択してください。",
    "offgridWebSaver.setup.consentNote": "写真を初めて保存する際、macOSが共有アプリコンテナへのアクセス許可を求める一度限りのプロンプトを表示することがあります。これは想定された動作です。「許可」を選んで、写真がOffgrid Galleryに届くようにしてください。",
    "offgridWebSaver.faq.kicker": "よくある質問",
    "offgridWebSaver.faq.title": "知っておきたいこと。",
    "offgridWebSaver.faq.q1": "写真はどこかにアップロードされますか?",
    "offgridWebSaver.faq.a1": "いいえ。写真は同じMac上でブラウザからOffgrid Galleryへ直接渡されます。当方のサーバーを含め、どこにも送信されません。",
    "offgridWebSaver.faq.q2": "どのボールトに保存されますか?",
    "offgridWebSaver.faq.a2": "Offgrid Galleryで現在アクティブなボールトです。そのボールトでiCloud Driveがオンになっている場合、他の取り込みと同様に自動的にそちらへ保存されます。",
    "offgridWebSaver.faq.q3": "なぜ別のアプリが必要なのですか?",
    "offgridWebSaver.faq.a3": "機能拡張だけでは他のアプリにファイルを書き込めません。Offgrid Companionは、SafariとChromeがOffgrid Galleryに写真を渡せるようにする、公証済みの小さなヘルパーアプリです。",
    "offgridWebSaver.footer.tagline": "右クリックひとつでOffgrid Galleryへ。",
    "offgridWebSaver.footer.backLink": "Offgrid Galleryに戻る",
  ...
  "zh-Hans": {
    ...
    "arithzo.feature.3.title": "连击成就，再创佳绩",
    "arithzo.feature.3.body": "叠加连击倍数、保持连续记录并解锁成就，向新的个人最佳成绩发起挑战。",
    ...
    "jlptbook.title": "JLPT Book",
    "jlptbook.subtitle": "词汇语法 五十音 能力考试",
    ...
    "jlptbook.feature.3.title": "全新填空模式",
    "jlptbook.feature.3.body": "在测验和复习中用字块拼出单词读音，配合每日打卡与30余项成就，学习动力满满。",
    "jlptbook.store.appStore": "在 App Store 打开 JLPT Book",
    "jlptbook.store.badgeAlt": "在 App Store 下载 JLPT Book",
    "jlptbook.screens.kicker": "截图",
    "jlptbook.screens.title": "学习、复习、测试，一站搞定。",
    "jlptbook.screens.1.alt": "JLPT Book主界面",
    "jlptbook.screens.2.alt": "JLPT Book单词卡学习界面",
    "jlptbook.screens.3.alt": "JLPT Book复习界面",
    "jlptbook.screens.4.alt": "JLPT Book测验界面",
    "jlptbook.screens.5.alt": "JLPT Book设置界面",
    ...
    "doubleslab.title": "DoublesLab",
    "doubleslab.subtitle": "双打KO率・耐久配置・伤害乱数",
    "doubleslab.store.appStore": "在App Store中打开DoublesLab",
    "doubleslab.store.badgeAlt": "在App Store下载DoublesLab",
    ...
    "doubleslab.feature.2.body": "支持天气、场地、墙、帮助、友情防守、蓄电池、超能力点、异常状态、致命一击和太晶化。",
    "doubleslab.feature.3.title": "支持Showdown导入，全面本地化",
    "doubleslab.feature.3.body": "以Showdown格式批量导入导出队伍，离线浏览全部宝可梦与招式，并在iPad/Mac上使用自适应侧边栏——支持英语、日语、简体中文和繁體中文。",
    ...
    "doubleslab.screens.kicker": "截图",
    "doubleslab.screens.title": "计算、优化、洞察环境，一应俱全。",
    "doubleslab.screens.1.alt": "DoublesLab伤害计算界面",
    "doubleslab.screens.2.alt": "DoublesLab SP优化界面",
    "doubleslab.screens.3.alt": "DoublesLab对环境伤害界面",
    "doubleslab.screens.4.alt": "DoublesLab威胁检测界面",
    "doubleslab.screens.5.alt": "DoublesLab队伍分析界面",
    "doubleslab.screens.6.alt": "DoublesLab图鉴界面",
    ...
    "meta.offgridGallery.description": "面向iPhone、iPad和Mac的私密照片与视频图库，支持本地存储、多个保险库和可选App Lock。",
    ...
    "offgridGallery.title": "Offgrid Gallery",
    "offgridGallery.subtitle": "私密的设备本地相册",
    "offgridGallery.store.appStore": "在App Store中打开Offgrid Gallery",
    "offgridGallery.store.badgeAlt": "在App Store下载Offgrid Gallery",
    "offgridGallery.overview.kicker": "概览",
    "offgridGallery.overview.title": "保留一个由你掌控的独立照片图库。",
    "offgridGallery.feature.1.title": "本地优先图库",
    "offgridGallery.feature.1.body": "导入或拍摄照片和视频到私密图库，全分辨率原图保存在你的设备上。",
    ...
    "offgridGallery.feature.3.body": "可选Face ID或Touch ID App Lock保护图库，还可使用多个保险库并行管理不同的照片库。",
    "offgridGallery.screens.kicker": "截图",
    "offgridGallery.screens.title": "照片与视频，私密保存。",
    "offgridGallery.screens.1.alt": "Offgrid Gallery照片网格",
    "offgridGallery.screens.2.alt": "Offgrid Gallery照片查看界面",
    "offgridGallery.screens.3.alt": "Offgrid Gallery设置界面",
    "offgridGallery.screens.4.alt": "Offgrid Gallery相册网格",
    ...
    "meta.offgridWebSaver.title": "Offgrid Web Saver | 将 Instagram 和 X 的照片保存到 Offgrid Gallery",
    "meta.offgridWebSaver.description": "在 Instagram 或 X 上右键点击照片，通过适用于 Mac 的免费 Safari 和 Chrome 浏览器扩展，将最高分辨率的照片直接保存到 Offgrid Gallery。",
    "offgridWebSaver.iconAlt": "Offgrid Gallery 应用图标",
    "offgridWebSaver.title": "Offgrid Web Saver",
    "offgridWebSaver.subtitle": "在 Instagram 或 X 上右键点击照片，将原图直接保存到 Offgrid Gallery。",
    "offgridWebSaver.availability": "适用于 Mac · Safari 和 Chrome",
    "offgridWebSaver.download.appButton": "下载 Offgrid Companion",
    "offgridWebSaver.download.chromeButton": "下载 Chrome 版",
    "offgridWebSaver.download.checking": "正在检查最新版本…",
    "offgridWebSaver.overview.kicker": "概览",
    "offgridWebSaver.overview.title": "Instagram 和 X 不允许你保存照片。这个工具可以。",
    "offgridWebSaver.overview.body": "右键点击任意照片，选择「保存到 Offgrid Gallery」。扩展程序会找到该照片的最高分辨率版本，并将其交给你 Mac 上的 Offgrid Gallery——无需截图，不损失画质，也不会上传到其他任何地方。它适用于任何有图片的网站，不仅限于 Instagram 和 X。",
    "offgridWebSaver.setup.kicker": "设置",
    "offgridWebSaver.setup.title": "三步即可开始保存。",
    "offgridWebSaver.setup.step1.title": "1. 打开一次 Offgrid Companion",
    "offgridWebSaver.setup.step1.body": "下载并打开一次该应用。它会注册 Safari 扩展，如果你使用 Chrome，还会自动连接。之后你可以退出它，也可以让它保持运行，随你选择。",
    "offgridWebSaver.setup.step2.title": "2. 在 Safari 中开启 Offgrid Saver",
    "offgridWebSaver.setup.step2.body": "在应用中点击「打开 Safari 扩展设置」，然后开启 Offgrid Saver，并允许它在你使用的网站上运行。",
    "offgridWebSaver.setup.step3.title": "3. 或在 Chrome 中以解压方式加载",
    "offgridWebSaver.setup.step3.body": "下载 Chrome 版并解压，打开 chrome://extensions，开启开发者模式，点击「加载已解压的扩展程序」，选择解压后的文件夹。",
    "offgridWebSaver.setup.consentNote": "首次保存照片时，macOS 可能会显示一次性提示，询问是否允许访问共享应用容器——这是正常现象。请选择「允许」，以便照片能够到达 Offgrid Gallery。",
    "offgridWebSaver.faq.kicker": "常见问题",
    "offgridWebSaver.faq.title": "值得了解的信息。",
    "offgridWebSaver.faq.q1": "这会把我的照片上传到别处吗?",
    "offgridWebSaver.faq.a1": "不会。照片直接从浏览器传输到同一台 Mac 上的 Offgrid Gallery——不会发送到任何服务器，包括我们自己的服务器。",
    "offgridWebSaver.faq.q2": "它会保存到哪个保管库?",
    "offgridWebSaver.faq.a2": "Offgrid Gallery 中当前处于活跃状态的保管库。如果该保管库已开启 iCloud 云盘，保存内容会像其他导入一样自动路由到那里。",
    "offgridWebSaver.faq.q3": "为什么需要安装单独的应用?",
    "offgridWebSaver.faq.a3": "浏览器扩展本身无法向其他应用写入文件。Offgrid Companion 是一个经过公证的小型辅助工具，用于让 Safari 和 Chrome 把照片交给 Offgrid Gallery。",
    "offgridWebSaver.footer.tagline": "只需右键点击，即可连接 Offgrid Gallery。",
    "offgridWebSaver.footer.backLink": "返回 Offgrid Gallery",
  ...
  "zh-Hant": {
    ...
    "arithzo.feature.3.title": "連擊成就，再創佳績",
    "arithzo.feature.3.body": "疊加連擊倍數、保持連續紀錄並解鎖成就，向新的個人最佳成績發起挑戰。",
    ...
    "jlptbook.title": "JLPT Book",
    "jlptbook.subtitle": "詞彙語法 五十音 能力考試",
    ...
    "jlptbook.feature.3.title": "全新填空模式",
    "jlptbook.feature.3.body": "在測驗和複習中用字塊拼出單字讀音，配合每日打卡與30餘項成就，學習動力滿滿。",
    "jlptbook.store.appStore": "在 App Store 打開 JLPT Book",
    "jlptbook.store.badgeAlt": "在 App Store 下載 JLPT Book",
    "jlptbook.screens.kicker": "截圖",
    "jlptbook.screens.title": "學習、複習、測驗，一站搞定。",
    "jlptbook.screens.1.alt": "JLPT Book主畫面",
    "jlptbook.screens.2.alt": "JLPT Book單字卡學習畫面",
    "jlptbook.screens.3.alt": "JLPT Book複習畫面",
    "jlptbook.screens.4.alt": "JLPT Book測驗畫面",
    "jlptbook.screens.5.alt": "JLPT Book設定畫面",
    ...
    "doubleslab.title": "DoublesLab",
    "doubleslab.subtitle": "雙打KO率・耐久配置・傷害亂數",
    "doubleslab.store.appStore": "在App Store中開啟DoublesLab",
    "doubleslab.store.badgeAlt": "在App Store下載DoublesLab",
    ...
    "doubleslab.feature.2.body": "支援天氣、場地、牆、幫助、友情防守、蓄電池、超能力點、異常狀態、要害和太晶化。",
    "doubleslab.feature.3.title": "支援Showdown匯入，全面在地化",
    "doubleslab.feature.3.body": "以Showdown格式批次匯入匯出隊伍，離線瀏覽全部寶可夢與招式，並在iPad/Mac上使用自適應側邊欄——支援英文、日文、簡體中文和繁體中文。",
    ...
    "doubleslab.screens.kicker": "截圖",
    "doubleslab.screens.title": "計算、最佳化、洞察環境，一應俱全。",
    "doubleslab.screens.1.alt": "DoublesLab傷害計算介面",
    "doubleslab.screens.2.alt": "DoublesLab SP最佳化介面",
    "doubleslab.screens.3.alt": "DoublesLab對環境傷害介面",
    "doubleslab.screens.4.alt": "DoublesLab威脅偵測介面",
    "doubleslab.screens.5.alt": "DoublesLab隊伍分析介面",
    "doubleslab.screens.6.alt": "DoublesLab圖鑑介面",
    ...
    "meta.offgridGallery.description": "面向iPhone、iPad和Mac的私密相片與影片圖庫，支援本機儲存、多個保險庫和可選App Lock。",
    ...
    "offgridGallery.title": "Offgrid Gallery",
    "offgridGallery.subtitle": "私密的裝置本機相簿",
    "offgridGallery.store.appStore": "在App Store中開啟Offgrid Gallery",
    "offgridGallery.store.badgeAlt": "在App Store下載Offgrid Gallery",
    "offgridGallery.overview.kicker": "概覽",
    "offgridGallery.overview.title": "保留一個由你掌控的獨立相片圖庫。",
    "offgridGallery.feature.1.title": "本機優先圖庫",
    "offgridGallery.feature.1.body": "匯入或拍攝相片和影片到私密圖庫，全解析度原圖儲存在你的裝置上。",
    ...
    "offgridGallery.feature.3.body": "可選Face ID或Touch ID App Lock保護圖庫，還可使用多個保險庫並行管理不同的相片庫。",
    "offgridGallery.screens.kicker": "截圖",
    "offgridGallery.screens.title": "相片與影片，私密保存。",
    "offgridGallery.screens.1.alt": "Offgrid Gallery相片網格",
    "offgridGallery.screens.2.alt": "Offgrid Gallery相片檢視畫面",
    "offgridGallery.screens.3.alt": "Offgrid Gallery設定畫面",
    "offgridGallery.screens.4.alt": "Offgrid Gallery相簿網格",
    ...
    "meta.offgridWebSaver.title": "Offgrid Web Saver | 將 Instagram 和 X 的相片儲存到 Offgrid Gallery",
    "meta.offgridWebSaver.description": "在 Instagram 或 X 上按右鍵點擊相片，透過適用於 Mac 的免費 Safari 和 Chrome 瀏覽器擴充功能，將最高解析度的相片直接儲存到 Offgrid Gallery。",
    "offgridWebSaver.iconAlt": "Offgrid Gallery 應用程式圖示",
    "offgridWebSaver.title": "Offgrid Web Saver",
    "offgridWebSaver.subtitle": "在 Instagram 或 X 上按右鍵點擊相片，將原圖直接儲存到 Offgrid Gallery。",
    "offgridWebSaver.availability": "適用於 Mac · Safari 和 Chrome",
    "offgridWebSaver.download.appButton": "下載 Offgrid Companion",
    "offgridWebSaver.download.chromeButton": "下載 Chrome 版",
    "offgridWebSaver.download.checking": "正在檢查最新版本…",
    "offgridWebSaver.overview.kicker": "概覽",
    "offgridWebSaver.overview.title": "Instagram 和 X 不讓你儲存相片。這個工具可以。",
    "offgridWebSaver.overview.body": "在任意相片上按右鍵，選擇「儲存到 Offgrid Gallery」。擴充功能會找到該相片的最高解析度版本，並將其交給你 Mac 上的 Offgrid Gallery——不需要截圖，不會損失畫質，也不會上傳到其他任何地方。它適用於任何有圖片的網站，不僅限於 Instagram 和 X。",
    "offgridWebSaver.setup.kicker": "設定",
    "offgridWebSaver.setup.title": "三個步驟即可開始儲存。",
    "offgridWebSaver.setup.step1.title": "1. 開啟一次 Offgrid Companion",
    "offgridWebSaver.setup.step1.body": "下載並開啟一次該應用程式。它會註冊 Safari 擴充功能，如果你使用 Chrome，還會自動連接。之後你可以結束它，也可以讓它保持執行，隨你選擇。",
    "offgridWebSaver.setup.step2.title": "2. 在 Safari 中開啟 Offgrid Saver",
    "offgridWebSaver.setup.step2.body": "在應用程式中按一下「開啟 Safari 擴充功能設定」，然後開啟 Offgrid Saver，並允許它在你使用的網站上執行。",
    "offgridWebSaver.setup.step3.title": "3. 或在 Chrome 中以未封裝方式載入",
    "offgridWebSaver.setup.step3.body": "下載 Chrome 版並解壓縮，開啟 chrome://extensions，開啟開發人員模式，按一下「載入未封裝項目」，選擇解壓縮後的資料夾。",
    "offgridWebSaver.setup.consentNote": "首次儲存相片時，macOS 可能會顯示一次性提示，詢問是否允許存取共用應用程式容器——這是正常現象。請選擇「允許」，以便相片能夠傳送到 Offgrid Gallery。",
    "offgridWebSaver.faq.kicker": "常見問題",
    "offgridWebSaver.faq.title": "值得了解的資訊。",
    "offgridWebSaver.faq.q1": "這會把我的相片上傳到別處嗎?",
    "offgridWebSaver.faq.a1": "不會。相片會直接從瀏覽器傳輸到同一台 Mac 上的 Offgrid Gallery——不會傳送到任何伺服器，包括我們自己的伺服器。",
    "offgridWebSaver.faq.q2": "它會儲存到哪個保險庫?",
    "offgridWebSaver.faq.a2": "Offgrid Gallery 中目前處於使用中的保險庫。如果該保險庫已開啟 iCloud 雲碟，儲存內容會像其他匯入項目一樣自動路由到那裡。",
    "offgridWebSaver.faq.q3": "為什麼需要安裝獨立的應用程式?",
    "offgridWebSaver.faq.a3": "瀏覽器擴充功能本身無法將檔案寫入其他應用程式。Offgrid Companion 是一個經過公證的小型輔助工具，用於讓 Safari 和 Chrome 將相片交給 Offgrid Gallery。",
    "offgridWebSaver.footer.tagline": "只需按一下右鍵，即可連接 Offgrid Gallery。",
    "offgridWebSaver.footer.backLink": "返回 Offgrid Gallery",
...
(() => {
  ...
  const SCREENSHOTS = {
    ...
    jlptbook: {
      en: {
        shot1: "assets/images/appstore/jlptbook/en-01_home.png",
        shot2: "assets/images/appstore/jlptbook/en-02_study.png",
        shot3: "assets/images/appstore/jlptbook/en-03_review.png",
        shot4: "assets/images/appstore/jlptbook/en-04_tests.png",
        shot5: "assets/images/appstore/jlptbook/en-05_settings.png"
      },
      "zh-Hans": {
        shot1: "assets/images/appstore/jlptbook/zh-Hans-01_home.png",
        shot2: "assets/images/appstore/jlptbook/zh-Hans-02_study.png",
        shot3: "assets/images/appstore/jlptbook/zh-Hans-03_review.png",
        shot4: "assets/images/appstore/jlptbook/zh-Hans-04_tests.png",
        shot5: "assets/images/appstore/jlptbook/zh-Hans-05_settings.png"
      },
      "zh-Hant": {
        shot1: "assets/images/appstore/jlptbook/zh-Hant-01_home.png",
        shot2: "assets/images/appstore/jlptbook/zh-Hant-02_study.png",
    ...
    doubleslab: {
      en: {
        shot1: "assets/images/appstore/doubleslab/en-01_calc.png",
        shot2: "assets/images/appstore/doubleslab/en-02_optimizer.png",
        shot3: "assets/images/appstore/doubleslab/en-03_meta-coverage.png",
        shot4: "assets/images/appstore/doubleslab/en-04_threats.png",
        shot5: "assets/images/appstore/doubleslab/en-05_team-analysis.png",
        shot6: "assets/images/appstore/doubleslab/en-06_pokedex.png"
      },
      ja: {
        shot1: "assets/images/appstore/doubleslab/ja-01_calc.png",
        shot2: "assets/images/appstore/doubleslab/ja-02_optimizer.png",
        shot3: "assets/images/appstore/doubleslab/ja-03_meta-coverage.png",
        shot4: "assets/images/appstore/doubleslab/ja-04_threats.png",
        shot5: "assets/images/appstore/doubleslab/ja-05_team-analysis.png",
        shot6: "assets/images/appstore/doubleslab/ja-06_pokedex.png"
      },
      "zh-Hans": {
        shot1: "assets/images/appstore/doubleslab/zh-Hans-01_calc.png",
        shot2: "assets/images/appstore/doubleslab/zh-Hans-02_optimizer.png",
        shot3: "assets/images/appstore/doubleslab/zh-Hans-03_meta-coverage.png",
        shot4: "assets/images/appstore/doubleslab/zh-Hans-04_threats.png",
        shot5: "assets/images/appstore/doubleslab/zh-Hans-05_team-analysis.png",
        shot6: "assets/images/appstore/doubleslab/zh-Hans-06_pokedex.png"
      },
      "zh-Hant": {
        shot1: "assets/images/appstore/doubleslab/zh-Hant-01_calc.png",
        shot2: "assets/images/appstore/doubleslab/zh-Hant-02_optimizer.png",
        shot3: "assets/images/appstore/doubleslab/zh-Hant-03_meta-coverage.png",
        shot4: "assets/images/appstore/doubleslab/zh-Hant-04_threats.png",
        shot5: "assets/images/appstore/doubleslab/zh-Hant-05_team-analysis.png",
        shot6: "assets/images/appstore/doubleslab/zh-Hant-06_pokedex.png"
      }
    },
    "offgrid-gallery": {
      en: {
        shot1: "assets/images/appstore/offgrid-gallery/en-01_grid.png",
        shot2: "assets/images/appstore/offgrid-gallery/en-02_photoview.png",
        shot3: "assets/images/appstore/offgrid-gallery/en-03_settings.png",
        shot4: "assets/images/appstore/offgrid-gallery/en-04_grid.png"
      },
      ja: {
        shot1: "assets/images/appstore/offgrid-gallery/ja-01_grid.png",
        shot2: "assets/images/appstore/offgrid-gallery/ja-02_photoview.png",
        shot3: "assets/images/appstore/offgrid-gallery/ja-03_settings.png",
        shot4: "assets/images/appstore/offgrid-gallery/ja-04_grid.png"
      },
      "zh-Hans": {
        shot1: "assets/images/appstore/offgrid-gallery/zh-Hans-01_grid.png",
        shot2: "assets/images/appstore/offgrid-gallery/zh-Hans-02_photoview.png",
        shot3: "assets/images/appstore/offgrid-gallery/zh-Hans-03_settings.png",
        shot4: "assets/images/appstore/offgrid-gallery/zh-Hans-04_grid.png"
      },
      "zh-Hant": {
        shot1: "assets/images/appstore/offgrid-gallery/zh-Hant-01_grid.png",
        shot2: "assets/images/appstore/offgrid-gallery/zh-Hant-02_photoview.png",
        shot3: "assets/images/appstore/offgrid-gallery/zh-Hant-03_settings.png",
        shot4: "assets/images/appstore/offgrid-gallery/zh-Hant-04_grid.png"
      }
    },
    arithzo: {
      en: {
